...
async function initClient() {
    ...
    client = new google.auth.OAuth2(key.client_id, key.client_secret, "http://localhost:3000/oauth2callback" // redirect URI must match Google Console
    );
    try {
...
export async function authorize(code) {
    ...
    if (!code) {
        ...
        console.log(authUrl);
        throw new Error("No authorization code provided. Open the URL above and allow access.");
    }
...
export async function listEvents(auth, tMin, tMax) {
